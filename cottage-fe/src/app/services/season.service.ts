...
import { PlayoffMatchup } from '../dto/playoff/playoff-matchup';
...
export class SeasonService {
  ...
  getExpectedPlayoffs(seasonId: string): Observable<PlayoffMatchup[]> {
    return this.http.get<PlayoffMatchup[]>(this.httpConstants.ENDPOINTS.GET_EXPECTED_PLAYOFFS(seasonId));
  }
